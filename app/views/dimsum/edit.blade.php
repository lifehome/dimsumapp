...
<body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="#">&#32232;&#36655;&#40670;&#24515;&#38917;&#30446;</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </nav>
    ...
    <div class="container">
        <h2>&#32232;&#36655;&#40670;&#24515;&#65306;<small>{{ $dimsum->name }} <small>(#{{ $dimsum->id }})</small></small></h2>

@if (Session::has('message'))
            <div class="alert alert-info">{{ Session::get('message') }}</div>
@endif
            {{ HTML::ul($errors->all()) }}
{{ Form::model($dimsum, array('route' => array('dimsum.update', $dimsum->id), 'method' => 'PUT', 'files' => true, 'class' => 'form')) }}
            ...
            <div class="form-group">
                ...
                {{ HTML::image($dimsum->pic_path, $dimsum->name.'(#'.$dimsum->id.')', array('class' => 'img-responsive', 'width' => 160, 'height' => 120)) }}<br/>
                <b>&#19978;&#36617;&#26032;&#22294;&#29255;</b>{{ Form::file('picture') }}
            </div>
            ...
            {{ Form::submit('Modify the dish!', array('class' => 'btn btn-primary')) }}
{{ Form::close() }}
    </div>
</body>
